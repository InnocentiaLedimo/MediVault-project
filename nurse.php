...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script> <!-- Add Chart.js script -->
</head>
<body>
...
<section style="display: flex;">
    ...
    <div class="main-content">
        ...
        if ($result->num_rows > 0) {
            $sql = "SELECT patients.*, appointments.* FROM patients
                LEFT JOIN appointments ON patients.firstName = appointments.appointmentFirstName
                UNION
                SELECT patients.*, appointments.*
                FROM appointments
                LEFT JOIN patients ON patients.firstName = appointments.appointmentFirstName";
                $result = $conn->query($sql);
    ...
    $sql = "SELECT users.*, appointments.*
            FROM users
            LEFT JOIN appointments ON users.firstName = appointments.appointmentFirstName
            UNION
            SELECT users.*, appointments.*
            FROM appointments
            LEFT JOIN users ON users.firstName = appointments.appointmentFirstName";
