...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // Prepare the SQL statement with placeholders
    $sql = "INSERT INTO prescriptions (medicationName, medicationPurpose, medicationDosage, medicationFrequency, physicianSignature) 
            VALUES (?, ?, ?, ?, ?)";
    ...
    // Bind parameters
    $stmt->bind_param("sssss", $medicationName, $medicationPurpose, $medicationDosage, $medicationFrequency, $signatureData);
