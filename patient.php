...
<section style="display: flex;">
    ...
    ?>
        ...
        <div id="settings" class="content-section">
            ...
            <form id="emergencyForm" class="settings-form">
                ...
                <!-- Insurance Information --> 
                 <form id="InsuranceForm" class="settings-form">
                ...
                <div class="input-group-book">
                    ...
                    <textarea id="coverDetails"  name="coverageDetails" rows="4" placeholder="Fill Here......" required></textarea>
                </div>
                <button type="submit">Save Information</button>
            </form>
